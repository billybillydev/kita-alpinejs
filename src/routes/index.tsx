        ...
        <div class="flex flex-col w-full h-full items-center gap-16 lg:gap-40 justify-center">
          <div class="flex justify-center items-center flex-col lg:flex-row">
            <div class="flex gap-8 flex-col  lg:w-1/2">
              ...
              <p class="leading[3rem] text-6xl font-bold">
          ...
          <div class="flex flex-col md:flex-row justify-between items-center w-full gap-6 lg:gap-12">
            ...
            >
              ...
              <p class="leading-2 text-base lg:text-xl text-zinc-500 font-medium">
                Minimum setup, maximum efficiency. Kita.js simplifies your
                workflow with a no-nonsense, practical approach.
              </p>
            </a>
            <a
            ...
            >
              ...
              <p class="leading-2 text-base lg:text-xl text-zinc-500 font-medium">
                Ready to use. Kita HTML stands out for its simplicity, allowing
                you to focus on what really matters: building powerful APIs.
              </p>
            </a>
            <a
            ...
            >
              ...
              <p class="leading-2 text-base lg:text-xl text-zinc-500 font-medium">
                Explore. Collaborate. Innovate. Access the Kita repository on
                GitHub and join the construction of smarter, more efficient
                routing.
              </p>
            </a>
          </div>
